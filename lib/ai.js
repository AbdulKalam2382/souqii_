...
export async function checkCompatibility(part1Id, part2Id) {
  ...
  You MUST return exactly this JSON structure (no markdown):
  {
    ...
    "accuracyRate": "95%", // Estimate your confidence level as a percentage string
    "performanceImpact": "Explain if this pairing bottlenecks performance or maximizes it. E.g. 'This GPU will utilize 100% of the CPU without bottlenecking.'",
